...
RELEASE_DATA=$(curl -s https://api.github.com/repos/imputnet/helium-linux/releases/latest)
...
mkdir -p "$ICON_DIR"
curl -sLo "$ICON_DIR/helium.png" "https://raw.githubusercontent.com/imputnet/helium/main/resources/branding/app_icon/raw.png"
